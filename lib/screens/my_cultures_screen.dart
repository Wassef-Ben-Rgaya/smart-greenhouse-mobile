        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(
              Icons.flag,
              'Current Phase',
              _translatePhaseName(culture.phaseActuelle),
              color: _getPhaseColor(_translatePhaseName(culture.phaseActuelle)),
            ),
            ...
            LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                _getPhaseColor(_translatePhaseName(culture.phaseActuelle)),
              ),
              minHeight: 8,
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) => EditCultureScreen(
                                culture: culture,
                                plantId: plant.id!,
                                plantName: _translatePlantName(plant.nom),
                              ),
                        ),
                      ).then((_) => _loadPlants()),
                ),
            ...
            Center(
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color.fromARGB(255, 32, 134, 37),
